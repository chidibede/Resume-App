                    ...
                    <table class="table" id="former-job-list">
                        ...
                        <tbody>
                            @foreach($former_jobs as $former_job)
                                <tr>
                                    <td><p class="text-primary">{{ $former_job->job_title}}/{{ $former_job->employer}}/{{ $former_job->location}}</p></td>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" data-route="{{ url('updateFormerJobs', $former_job->id) }}" class="collapse"  id="former_job-{{ $former_job->id }}">
                                            <input type="hidden" name="_method" value="PATCH">
                                            @csrf
                                            <input type="hidden" name="former_job_id" id="former_job_id{{$former_job->id}}" value="{{$former_job->id}}">
                                            <div class="card" style="border: none;">
                                                <div class="form-group">
                                                    <input type="text" name="employer" id="employer{{$former_job->id}}" placeholder="former Employer"
                                                        class="form-control w3-margin-bottom" value="{{$former_job->employer}}">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="job_title" id="job_title{{$former_job->id}}" placeholder="Job Title" class="form-control" value="{{$former_job->job_title}}">
                                                </div>

                                                <div class="form-group">
                                                    <input type="text" name="location" id="location{{$former_job->id}}" placeholder="Job Location" class="form-control" value="{{$former_job->location}}">
                                                </div>

                                                <div class="form-group">
                                                    <span class="w3-medium w3-text-gray">Job Description</span>
                                                    <textarea name="job_description" class="form-control" rows="4" id="comment{{$former_job->id}}" >{{$former_job->job_description}}</textarea>
                                                </div>
                                                <div class="form-group" style="width:50%;">
                                                    <span class="w3-medium w3-text-gray">Start Date</span>
                                                    <input type="date" name="start_date" id="start_date{{$former_job->id}}" name="date" class="form-control" value="{{$former_job->start_date}}">
                                                </div>

                                                <div class="form-group" style="width:50%;">
                                                    <span class="w3-medium w3-text-gray">End Date</span>
                                                    <input type="date" name="end_date" id="end_date{{$former_job->id}}" name="date" class="form-control" value="{{$former_job->end_date}}">
                                                </div>


                                                <div class="form-group">
                                                    <button type="button" data-id={{$former_job->id}} class="btn btn-primary updateFormerJobs">Save</button>
                                                </div>
                                                <hr><br>
                        ...
                        <form  method="POST" data-route="{{ route('createFormerJobs') }}" class="collapse former-employment-refresh" id="former_employment">
                            @csrf
                            <div class="card" style="border: none;">
                                <div class="form-group">
